...
from urban_routes_main_page import UrbanRoutesPage  # Import the


def test_add_driver_license_custom_camping_option():
    driver = webdriver.Chrome()
    # Open the app - update the URL after starting the server
    driver.get('https://cnt-8e9504e6-d18a-4350-aa03-d2369b4d0b0c.containerhub.tripleten-services.com')
